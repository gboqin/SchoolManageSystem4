...
namespace SchoolManageSystem.Common.JWT
{
    /// <summary>
    /// token管理类
    /// </summary>
    public class TokenManager
    {
        ...
        /// 秘钥  4的倍数  长度大于等于24
        /// </summary>
        private static string _secret = "gbqin0102030405060708090asdf";
        /// <summary>
        /// 发布者
        /// </summary>
        private static string _issuer = "gb.qin";
        ...
        private static ClaimsPrincipal GetPrincipal(string token, out DateTime dateTime)
        {
            ...
            catch (Exception e)
            {
                dateTime = DateTime.Now;
                //NLog文件夹
                NLog.LogHelper.Logger.Fatal(e, "Token验证失败");
                return null;
            }
        }
    }
